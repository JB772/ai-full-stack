...
@Component({
  ...
  imports: [RouterLink, DatePipe, ButtonModule, TagModule, RowAuditBadgeComponent],
...
export class AppUserDetail implements OnInit {
  ...
  // the Admin role regardless). Role management lives on the edit form, not this read-only view.
